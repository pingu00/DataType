...
//     element tmp;
//     int max =  maze[current.r][current.c];
//     if (max < maze[current.r-1][current.c]){
//         max = maze[current.r-1][current.c];
//         tmp.r = current.r-1;
//         tmp.c = current.c;
//     };
//     if (max < maze[current.r+1][current.c]){
...
//         tmp.c = current.c;
//     };
//     if (max < maze[current.r][current.c-1]){
//         max = maze[current.r][current.c-1];
//         tmp.r = current.r;
//         tmp.c = current.c-1;
//     };
//     if (max < maze[current.r][current.c+1]){
