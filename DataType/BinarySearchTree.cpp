...
//
//        // 세 번째 경우: 자식이 2개인 경우
//        if (get_height(root->right) < get_height(root->left) ) {// 조건식을 완성하시오.
...
//}
//
///* scanf_s function does not work in my macbook. so I use funtion "scan"*/
//
//
//
//
